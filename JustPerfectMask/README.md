# Étude de cas – Just Perfect Mask

## Innovation produit, entrepreneuriat et gestion de projet complexe

## 1. Présentation du projet

Just Perfect Mask est une marque que j'ai créée et développée pendant la crise sanitaire afin de répondre à un besoin utilisateur spécifique : proposer une solution textile adaptée aux porteurs de barbe.

À cette période, les masques classiques posaient plusieurs difficultés aux personnes portant une barbe : inconfort, mauvais maintien, gêne esthétique, difficulté d'usage quotidien et absence de solution réellement pensée pour cette population.
...
Le point de départ du projet repose sur une observation simple : les masques disponibles sur le marché étaient principalement conçus pour des visages rasés ou peu barbus.
...
J'ai développé une gamme de masques textiles spécifiquement conçue pour les porteurs de barbe, avec plusieurs tailles afin de s'adapter à différentes longueurs et morphologies.
...
Le développement de Just Perfect Mask a nécessité de piloter plusieurs dimensions en parallèle.

### Analyse du besoin

J'ai d'abord identifié un besoin utilisateur non couvert, à partir de l'observation du marché, des usages et des difficultés exprimées par les porteurs de barbe.
...
Le projet a été développé dans un contexte sanitaire évolutif. J'ai donc réalisé une veille continue sur les recommandations AFNOR, les publications de la DGA et les données techniques disponibles concernant les matériaux, la filtration, la respirabilité et les usages des masques textiles.

Cette veille ne correspondait pas à une certification officielle du produit, mais à une démarche de compréhension, de sélection et d'amélioration technique.
...
Just Perfect Mask a été un projet complexe car il combinait plusieurs contraintes simultanées.

### Contraintes techniques

Il fallait concevoir un produit textile adapté à une morphologie spécifique, avec des attentes particulières en matière de confort, de tenue et d'usage.

### Contraintes réglementaires et sanitaires

Le projet a été mené dans un environnement où les recommandations et les attentes évoluaient rapidement. Il fallait suivre les informations disponibles, comprendre les limites du produit textile et éviter de revendiquer des niveaux de certification non obtenus.

### Contraintes industrielles

La production nécessitait de gérer les matériaux, la fabrication, les tailles, les délais, les approvisionnements et les pics de demande.

### Contraintes commerciales

Il fallait faire connaître une marque nouvelle, convaincre des partenaires, créer une communauté, distribuer le produit et répondre à une demande parfois très variable.

### Contraintes humaines

Le projet impliquait de coordonner des acteurs différents : fabricants, barbiers, distributeurs, clients, ambassadeurs, influenceurs et points de vente.

---

## 6. Écosystème mobilisé

Le développement de Just Perfect Mask s'est appuyé sur un écosystème de partenaires et de relais de terrain.
...
Lorsque ce contexte a évolué, le besoin du marché a naturellement diminué. J'ai envisagé plusieurs pistes de prolongement, notamment autour d'usages liés à la pollution ou à d'autres situations de protection du visage.

Cependant, ces pistes ne correspondaient pas suffisamment aux usages dominants du marché français, ni aux ressources nécessaires pour construire un nouveau modèle pérenne.

Cette limite a été un enseignement important : un projet innovant doit aussi être pensé dans sa capacité à évoluer, à pivoter ou à s'inscrire dans un usage durable.
...
Après une première partie de carrière dans l'industrie pharmaceutique, où j'ai acquis une culture de la qualité, de la rigueur et des processus, ce projet entrepreneurial m'a permis de développer une approche plus globale de l'innovation.
